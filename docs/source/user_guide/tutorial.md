...
1.  Ensure your AiiDA profile contains the user email you want to authenticate with.
2.  Provide credentials through `AIIDA_RESTAPI_AUTH_CREDENTIALS_JSON` or `AIIDA_RESTAPI_AUTH_CREDENTIALS_FILE`.
3.  Start the REST API server.
4.  Go to http://127.0.0.1:8000/docs
5.  Click on "Authorize"
6.  Use your user email as username and the corresponding password
7.  Click on "Authorize", then "Close"
