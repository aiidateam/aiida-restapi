...
async def test_add_process(async_client: AsyncClient, default_test_add_process):
...
@pytest.mark.usefixtures('authenticate')
def test_add_process_invalid_entry_point(client: TestClient, default_test_add_process):
